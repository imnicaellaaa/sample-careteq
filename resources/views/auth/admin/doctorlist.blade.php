...
@endif
    <div class="container table-responsive py-5">
        ...
        {{-- Edit Modal --}}
    @foreach ($doctor as $doctors )
       <form name="editDoctor" action="{{ route('admin.editDoctorInformation', $doctors->id ) }}" method="POST">
                @csrf
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="addModallabel" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group flex-nowrap mb-2">
                                <input type="text" value="{{$doctors->id}}" name="doctors_id" id="doctors_id" readonly>
                            </div>
                            <div class="input-group flex-nowrap mb-2">
                                {{-- Edit Ttile --}}
                            ...
                            <div class="input-group flex-nowrap mb-2">
                                {{-- Edit License Number --}}
                                <input type="text" class="form-control" value="{{ $doctors->license_no }}" aria-label="firstname"
                                    aria-describedby="addon-wrapping" name="license_no" id="license_no" >
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
